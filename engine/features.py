# Start function with face authentication
def start():
    if face_authenticate():
        print("Authentication successful 🚀")
        playAssistantSound()
        startVoiceAssistant()
    else:
        print("Authentication failed ❌")
# Face authentication loop
def face_authenticate():
    while True:
        success = detect_face()  # tumhara face detection function
        if success:
            print("Face recognized ✅")
            break   # bahar niklo loop se
import os
